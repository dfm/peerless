...
according to the two-bin population model described by \ref{tab:occurrence} and 
generate a population of 1000 detected signals.

We list the probabilities for each of our candidates to belong to each
hypothesis in \ref{tab:fpp}.  We find that the two deepest signals in our
...
discussed in \sect{}, 4754460 (which we calculate to have a 5\% false positive
