...
survey baseline are crucial for the future of of exoplanet research with the
transit method.
...
prospects for follow-up, and compare to calculated occurrence rate to results
based on discoveries using different planet discovery methods.
