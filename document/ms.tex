...
The difference between the observed radius distributions apparent in
\dfmfig{obs-dist} can be attributed to the drop off in sensitivity of our
search at small planet radius depicted in \dfmfig{completeness}.
The \kepler\ survey, on the other hand, has increasing sensitivity to smaller
planets due to the addition of multiple transits at shorter period.
