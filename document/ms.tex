...
% This occurrence rate estimate~--~and all other results based on transit
% surveys~--~is affected by Malmquist bias.
% For a transit survey, this bias enters in two ways: \emph{(a)} contamination
% of the sample by giants, and \emph{(b)} discrepancy
...
\dfmtodo{More words here about comparison.}
