...
This procedure yields about 100 \emph{light curve sections} for the typical
\kepler\ target.
...
``sections'' of contiguous measurements; these are the base unit for splitting
the dataset.
...
\subsection{Initial candidate detection}
