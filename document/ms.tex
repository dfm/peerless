...
other known false positives \citep{Coughlin:2016}, and seven extra blacklisted
stars.
The final catalog contains 39,518 targets and the parameter distribution is
...
\tablecaption{caption\label{tab:blacklist}}
\tablehead{\colhead{kic id} & \colhead{comments}}
\startdata
3323887  & A known system with transit timing variations (Kepler-9) \\
4482348	 & Crazy crosstalk outliers \\
4450472	 & noise \\
4586468	 & EB not in list \\
5438845	 & noise \\
8009496	 & ephemeris match \\
10068041 & AMS \\
\enddata
\end{deluxetable}
